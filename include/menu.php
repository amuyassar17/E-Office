...
<nav class="blue-grey darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">school</i> E-Office</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
                    ...
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                ...
                                echo '<h5 class="smk-side">Universitas Negeri Makassar</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jl. A. P. Pettarani, Tidung, Kec. Rappocini, Kota Makassar, Sulawesi Selatan 90222</p>';
                            }
                        }
                    ?>
                </div>
            ...
            <li class="no-padding">
                ...
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">repeat</i> Jenis Surat</a>
                        <div class="collapsible-body">
                            <ul>
            ...
            <li class="no-padding">
                <ul class="collapsible collapsible-accordion">
                    <li>
                        <a class="collapsible-header"><i class="material-icons">image</i> Galeri Surat</a>
                        <div class="collapsible-body">
                            <ul>
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="E-Office hide-on-med-and-down"><i class="material-icons md-36">school</i> E-Office</a></li>
            <li><div class="grs"></></li>
            <li><a href="./"><i class="material-icons"></i>&nbsp; Beranda</a></li>
            <?php
                if($_SESSION['admin'] == 1 || $_SESSION['admin'] == 3){ ?>
            <li><a class="dropdown-button" href="#!" data-activates="transaksi">Jenis Surat <i class="material-icons md-18">arrow_drop_down</i></a></li>
