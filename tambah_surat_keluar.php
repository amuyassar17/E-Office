...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        if (
            $_REQUEST['no_agenda'] == "" || $_REQUEST['jenis_surat'] || $_REQUEST['no_surat'] == "" || $_REQUEST['tujuan'] == "" || $_REQUEST['isi'] == ""
            || $_REQUEST['tgl_surat'] == ""
        ) {
            ...
            if (!preg_match("/^[0-9]*$/", $no_agenda)) {
                ...
                if (!preg_match("/^[a-zA-Z0-9.\/ -]*$/", $jenis_surat)) {
                    $_SESSION['jenis_surat'] = 'Form No Surat hanya boleh mengandung karakter huruf, angka, spasi, titik(.), minus(-) dan garis miring(/)';
                    echo '<script language="javascript">window.history.back();</script>';
                } else {
                                        ...
                                        if ($file != "") {
                                            ...
                                            if (in_array($eks, $ekstensi) == true) {
                                                if ($ukuran < 2500000) {
                                                    ...
                                                    $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,jenis_surat,tujuan,no_surat,isi,tgl_surat,
                                                                tgl_catat,file,id_user)
                                                                VALUES('$no_agenda','$jenis_surat','$tujuan','$no_surat','$isi','$tgl_surat',NOW(),'$nfile','$id_user')");
                                            ...
                                            $query = mysqli_query($config, "INSERT INTO tbl_surat_keluar(no_agenda,jenis_surat,tujuan,no_surat,isi,tgl_surat,
                                                        ...
                                                        VALUES('$no_agenda','$jenis_surat','$tujuan','$no_surat','$isi','$tgl_surat',NOW(),'','$id_user')");
