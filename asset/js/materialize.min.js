function toast(t, e, i, n) {
    function a(t) {
        var e = $("<div class='toast'></div>").addClass(i).html(t);
        return e.hammer({
            prevent_default: !1
        }).bind("pan", function (t) {
    ...
    var r = $("#toast-container"),
        o = a(t);
    r.append(o), o.css({
        top: parseFloat(o.css("top")) + 35 + "px",
        opacity: 0
    }), o.velocity({
        top: "0px",
        opacity: 1
    ...
    var s = e,
        l = setInterval(function () {
            0 === o.parent().length && window.clearInterval(l), o.hasClass("panning") || (s -= 100), 0 >= s && (o.velocity({
                opacity: 0,
                marginTop: "-40px"
            }, {
                duration: 375,
...
jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
    ...
    function (t) {
        ...
        return function (t, e, i, n) {
            ...
            function l(t, i, n, a) {
                ...
                var C = x ? new Float32Array(b) : new Array(b),
                    S = !1,
                    T = function (e) {
                        return S || h(), t === i && n === a ? e : 0 === e ? 0 : 1 === e ? 1 : l(p(e), i, a)
                    };
            ...
            function c(t) {
                if (t)
                    for (var e = (new Date).getTime(), i = 0, a = b.State.calls.length; a > i; i++)
                        if (b.State.calls[i]) {
                            var r = b.State.calls[i],
                                s = r[0],
                                l = r[2],
                                u = r[3],
                                p = !!u;
                            u || (u = b.State.calls[i][3] = e - 16);
                            for (var h = Math.min((e - u) / l.duration, 1), v = 0, m = s.length; m > v; v++) {
                                var y = s[v],
                                    w = y.element;
                                if (o(w)) {
                                    var k = !1;
                                    if (l.display !== n && null !== l.display && "none" !== l.display) {
                                        if ("flex" === l.display) {
                                            ...
                                            f.each(S, function (t, e) {
                                                x.setPropertyValue(w, "display", e)
                                            })
                                        }
                                    ...
                                    for (var T in y)
                                        if ("element" !== T) {
                                            ...
                                            if (1 === h) O = A.endValue;
                                            else if (O = A.startValue + (A.endValue - A.startValue) * P(h), !p && O === A.currentValue) continue;
                                            if (A.currentValue = O, x.Hooks.registered[T]) {
                                                var E = x.Hooks.getRoot(T),
                                                    q = o(w).rootPropertyValueCache[E];
                                                q && (A.rootPropertyValue = q)
                                            }
                                            var I = x.setPropertyValue(w, T, A.currentValue + (0 === parseFloat(O) ? "" : A.unitType), A.rootPropertyValue, A.scrollData);
                                            x.Hooks.registered[T] && (o(w).rootPropertyValueCache[E] = x.Normalizations.registered[E] ? x.Normalizations.registered[E]("extract", null, I[1]) : I[1]), "transform" === I[0] && (k = !0)
                                        } l.mobileHA && o(w).transformCache.translate3d === n && (o(w).transformCache.translate3d = "(0px, 0px, 0px)", k = !0), k && x.flushTransformCache(w)
                                }
                            }
                            l.display !== n && "none" !== l.display && (b.State.calls[i][2].display = !1), l.visibility !== n && "hidden" !== l.visibility && (b.State.calls[i][2].visibility = !1), l.progress && l.progress.call(r[1], r[1], h, Math.max(0, u + l.duration - e), u), 1 === h && d(i)
            ...
            function d(t, e) {
                ...
                for (var i = b.State.calls[t][0], a = b.State.calls[t][1], r = b.State.calls[t][2], s = b.State.calls[t][4], l = !1, u = 0, c = i.length; c > u; u++) {
                    var d = i[u].element;
                    if (e || r.loop || ("none" === r.display && x.setPropertyValue(d, "display", r.display), "hidden" === r.visibility && x.setPropertyValue(d, "visibility", r.visibility)), r.loop !== !0 && (f.queue(d)[1] === n || !/\.velocityQueueEntryFlag/i.test(f.queue(d)[1])) && o(d)) {
                        o(d).isAnimating = !1, o(d).rootPropertyValueCache = {};
                        var p = !1;
                        f.each(x.Lists.transforms3D, function (t, e) {
                            var i = /^scale/.test(e) ? 1 : 0,
                                a = o(d).transformCache[e];
                            o(d).transformCache[e] !== n && new RegExp("^\\(" + i + "[^.]").test(a) && (p = !0, delete o(d).transformCache[e])
                    ...
                    s && r.loop !== !0 && s(a), r.loop !== !0 || e || (f.each(o(d).tweensContainer, function (t, e) {
            ...
            var f, p = function () {
                ...
                v = !1;
            if (t.fn && t.fn.jquery ? (f = t, v = !0) : f = e.Velocity.Utilities, 8 >= p && !v) throw new Error("Velocity: IE8 and below require jQuery to be loaded before Velocity.");
            ...
            var w = function () {
                ...
                return function n(t, e, a) {
                    var r, o, s, l = {
                        ...
                        d = 1e-4,
                        f = .016;
                    for (t = parseFloat(t) || 500, e = parseFloat(e) || 20, a = a || null, l.tension = t, l.friction = e, r = null !== a, r ? (c = n(t, e), o = c / a * f) : o = f; s = i(s || l, o), u.push(1 + s.x), c += 16, Math.abs(s.x) > d && Math.abs(s.v) > d;);
                    return r ? function (t) {
                ...
                getPropertyValue: function (t, i, a, r) {
                    function s(t, i) {
                        ...
                        if (8 >= p) l = f.css(t, i);
                            ...
                            var h;
                            h = o(t) === n ? e.getComputedStyle(t, null) : o(t).computedStyle ? o(t).computedStyle : o(t).computedStyle = e.getComputedStyle(t, null), (p || b.State.isFirefox) && "borderColor" === i && (i = "borderTopColor"), l = 9 === p && "filter" === i ? h.getPropertyValue(i) : h[i], ("" === l || null === l) && (l = t.style[i]), a()
                        }
                    ...
                    return /^[\d-]/.test(l) || (l = o(t) && o(t).isSVG && x.Names.SVGAttribute(i) ? /^(height|width)$/i.test(i) ? t.getBBox()[i] : t.getAttribute(i) : s(t, x.Names.prefixCheck(i)[0])), x.Values.isCSSNullValue(l) && (l = 0), b.debug >= 2 && console.log("Get " + i + ": " + l), l
                },
                ...
                flushTransformCache: function (t) {
                    ...
                    if ((p || b.State.isAndroid && !b.State.isChrome) && o(t).isSVG) {
                        ...
                        f.each(o(t).transformCache, function (e) {
                            return a = o(t).transformCache[e], "transformPerspective" === e ? (r = a, !0) : (9 === p && "rotateZ" === e && (e = "rotate"), void(i += e + a + " "))
                        }), r && (i = "perspective" + r + " " + i)
                    }
            ...
            x.Hooks.register(), x.Normalizations.register(), b.hook = function (t, e, i) {
                var a = n;
                return t = r(t), f.each(t, function (t, r) {
            ...
            var k = function () {
                ...
                function s() {
                    function t() {
                        function t(t, e) {
                            var i = n,
                                a = n,
                                r = n;
                            return g.isArray(t) ? (i = t[0], !g.isArray(t[1]) && /^[\d-]/.test(t[1]) || g.isFunction(t[1]) || x.RegEx.isHex.test(t[1]) ? r = t[1] : (g.isString(t[1]) && !x.RegEx.isHex.test(t[1]) || g.isArray(t[1])) && (a = e ? t[1] : u(t[1], l.duration), t[2] !== n && (r = t[2]))) : i = t, e || (a = a || l.easing), g.isFunction(i) && (i = i.call(s, T, S)), g.isFunction(r) && (r = r.call(s, T, S)), [i || 0, a, r]
                        }
                        ...
                        function h() {
                            var t = {
                                ...
                                a = t.fontSize === j.lastFontSize;
                            j.lastParent = t.myParent, j.lastPosition = t.position, j.lastFontSize = t.fontSize;
                            var r = 100,
                                l = {};
                            if (a && n) l.emToPx = j.lastEmToPx, l.percentToPxWidth = j.lastPercentToPxWidth, l.percentToPxHeight = j.lastPercentToPxHeight;
                            else {
                                var u = o(s).isSVG ? i.createElementNS("http://www.w3.org/2000/svg", "rect") : i.createElement("div");
                                b.init(u), t.myParent.appendChild(u), f.each(["overflow", "overflowX", "overflowY"], function (t, e) {
                                    ...
                                    b.CSS.setPropertyValue(u, e, r + "%")
                                }), b.CSS.setPropertyValue(u, "paddingLeft", r + "em"), l.percentToPxWidth = j.lastPercentToPxWidth = (parseFloat(x.getPropertyValue(u, "width", null, !0)) || 1) / r, l.percentToPxHeight = j.lastPercentToPxHeight = (parseFloat(x.getPropertyValue(u, "height", null, !0)) || 1) / r, l.emToPx = j.lastEmToPx = (parseFloat(x.getPropertyValue(u, "paddingLeft")) || 1) / r, t.myParent.removeChild(u)
                            }
                            return null === j.remToPx && (j.remToPx = parseFloat(x.getPropertyValue(i.body, "fontSize")) || 16), null === j.vwToPx && (j.vwToPx = parseFloat(e.innerWidth) / 100, j.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = j.remToPx, l.vwToPx = j.vwToPx, l.vhToPx = j.vhToPx, b.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), s), l
                        }
                        if (l.begin && 0 === T) try {
                            l.begin.call(v, v)
                        } catch (m) {
                        ...
                        if ("scroll" === E) {
                            var k, C, O, A = /^x$/i.test(l.axis) ? "Left" : "Top",
                                q = parseFloat(l.offset) || 0;
                            l.container ? g.isWrapped(l.container) || g.isNode(l.container) ? (l.container = l.container[0] || l.container, k = l.container["scroll" + A], O = k + f(s).position()[A.toLowerCase()] + q) : l.container = null : (k = b.State.scrollAnchor[b.State["scrollProperty" + A]], C = b.State.scrollAnchor[b.State["scrollProperty" + ("Left" === A ? "Top" : "Left")]], O = f(s).offset()[A.toLowerCase()] + q), d = {
                                scroll: {
                                    rootPropertyValue: !1,
                                    startValue: k,
                                    currentValue: k,
                                ...
                                element: s
                            }, b.debug && console.log("tweensContainer (scroll): ", d.scroll, s)
                        } else if ("reverse" === E) {
                            if (!o(s).tweensContainer) return void f.dequeue(s, l.queue);
                            "none" === o(s).opts.display && (o(s).opts.display = "auto"), "hidden" === o(s).opts.visibility && (o(s).opts.visibility = "visible"), o(s).opts.loop = !1, o(s).opts.begin = null, o(s).opts.complete = null, w.easing || delete l.easing, w.duration || delete l.duration, l = f.extend({}, o(s).opts, l);
                            var I = f.extend(!0, {}, o(s).tweensContainer);
                            for (var _ in I)
                                if ("element" !== _) {
                                    var M = I[_].startValue;
                                    I[_].startValue = I[_].currentValue = I[_].endValue, I[_].endValue = M, g.isEmptyObject(w) || (I[_].easing = l.easing), b.debug && console.log("reverse tweensContainer (" + _ + "): " + JSON.stringify(I[_]), s)
                                } d = I
                        } else if ("start" === E) {
                            var I;
                            o(s).tweensContainer && o(s).isAnimating === !0 && (I = o(s).tweensContainer), f.each(y, function (e, i) {
                                if (RegExp("^" + x.Lists.colors.join("$|^") + "$").test(e)) {
                                    ...
                                    if (x.RegEx.isHex.test(r)) {
                                        for (var l = ["Red", "Green", "Blue"], u = x.Values.hexToRgb(r), c = s ? x.Values.hexToRgb(s) : n, d = 0; d < l.length; d++) {
                                            var f = [u[d]];
                                            o && f.push(o), c !== n && f.push(c[d]), y[e + l[d]] = f
                                        }
                                        delete y[e]
                                    }
                                }
                            ...
                            for (var V in y) {
                                ...
                                var N = x.Hooks.getRoot(V),
                                    R = !1;
                                if (o(s).isSVG || x.Names.prefixCheck(N)[1] !== !1 || x.Normalizations.registered[N] !== n) {
                                    (l.display !== n && null !== l.display && "none" !== l.display || l.visibility !== n && "hidden" !== l.visibility) && /opacity|filter/.test(V) && !L && 0 !== Q && (L = 0),
                                        l._cacheValues && I && I[V] ? (L === n && (L = I[V].endValue + I[V].unitType), R = o(s).rootPropertyValueCache[N]) : x.Hooks.registered[V] ? L === n ? (R = x.getPropertyValue(s, N), L = x.getPropertyValue(s, V, R)) : R = x.Hooks.templates[N][1] : L === n && (L = x.getPropertyValue(s, V));
                                    var z, W, H, X = !1;
                                    if (z = p(V, L), L = z[0], H = z[1], z = p(V, Q), Q = z[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return X = e, ""
                                        }), W = z[1], L = parseFloat(L) || 0, Q = parseFloat(Q) || 0, "%" === W && (/^(fontSize|lineHeight)$/.test(V) ? (Q /= 100, W = "em") : /^scale/.test(V) ? (Q /= 100, W = "") : /(Red|Green|Blue)$/i.test(V) && (Q = Q / 100 * 255, W = "")), /[\/*]/.test(X)) W = H;
                                    else if (H !== W && 0 !== L)
                                        if (0 === Q) W = H;
                                        else {
                                            r = r || h();
                                            ...
                                            switch (H) {
                                                case "%":
                                                    L *= "x" === Y ? r.percentToPxWidth : r.percentToPxHeight;
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                            ...
                                            switch (W) {
                                                case "%":
                                                    L *= 1 / ("x" === Y ? r.percentToPxWidth : r.percentToPxHeight);
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                    ...
                                    d[V] = {
                                        ...
                                        unitType: W,
                                        easing: F
                                    }, b.debug && console.log("tweensContainer (" + V + "): " + JSON.stringify(d[V]), s)
                                } else b.debug && console.log("Skipping [" + N + "] due to a lack of browser support.")
                            }
                            d.element = s
                        }
                        d.element && (x.Values.addClass(s, "velocity-animating"), D.push(d), "" === l.queue && (o(s).tweensContainer = d, o(s).opts = l), o(s).isAnimating = !0, T === S - 1 ? (b.State.calls.length > 1e4 && (b.State.calls = a(b.State.calls)), b.State.calls.push([D, v, l, null, P.resolver]), b.State.isTicking === !1 && (b.State.isTicking = !0, c())) : T++)
                    }
                    var r, s = this,
                        l = f.extend({}, b.defaults, w),
                        d = {};
                    switch (o(s) === n && b.init(s), parseFloat(l.delay) && l.queue !== !1 && f.queue(s, l.queue, function (t) {
                    ...
                    b.mock !== !1 && (b.mock === !0 ? l.duration = l.delay = 1 : (l.duration *= parseFloat(b.mock) || 1, l.delay *= parseFloat(b.mock) || 1)), l.easing = u(l.easing, l.duration), l.begin && !g.isFunction(l.begin) && (l.begin = null), l.progress && !g.isFunction(l.progress) && (l.progress = null), l.complete && !g.isFunction(l.complete) && (l.complete = null), l.display !== n && null !== l.display && (l.display = l.display.toString().toLowerCase(), "auto" === l.display && (l.display = b.CSS.Values.getDisplayType(s))), l.visibility !== n && null !== l.visibility && (l.visibility = l.visibility.toString().toLowerCase()), l.mobileHA = l.mobileHA && b.State.isMobile && !b.State.isGingerbread, l.queue === !1 ? l.delay ? setTimeout(t, l.delay) : t() : f.queue(s, l.queue, function (e, i) {
                        return i === !0 ? (P.promise && P.resolver(v), !0) : (b.velocityQueueEntryFlag = !0, void t(e))
                    }), "" !== l.queue && "fx" !== l.queue || "inprogress" === f.queue(s)[0] || f.dequeue(s)
                }
                var l, p, h, v, y, w, C = arguments[0] && (f.isPlainObject(arguments[0].properties) && !arguments[0].properties.names || g.isString(arguments[0].properties));
                if (g.isWrapped(this) ? (l = !1, h = 0, v = this, p = this) : (l = !0, h = 1, v = C ? arguments[0].elements : arguments[0]), v = r(v)) {
                    C ? (y = arguments[0].properties, w = arguments[0].options) : (y = arguments[h], w = arguments[h + 1]);
                    var S = v.length,
                        T = 0;
                    if ("stop" !== y && !f.isPlainObject(w)) {
                        var O = h + 1;
                        w = {};
                        for (var A = O; A < arguments.length; A++) g.isArray(arguments[A]) || !/^(fast|normal|slow)$/i.test(arguments[A]) && !/^\d/.test(arguments[A]) ? g.isString(arguments[A]) || g.isArray(arguments[A]) ? w.easing = arguments[A] : g.isFunction(arguments[A]) && (w.complete = arguments[A]) : w.duration = arguments[A]
                    }
                    var P = {
                        promise: null,
                        resolver: null,
                    ...
                    l && b.Promise && (P.promise = new b.Promise(function (t, e) {
                        ...
                        case "stop":
                            ...
                            return f.each(b.State.calls, function (t, e) {
                                e && f.each(e[1], function (i, a) {
                                    var r = g.isString(w) ? w : "";
                                    return w !== n && e[2].queue !== r ? !0 : void f.each(v, function (e, i) {
                                        i === a && (w !== n && (f.each(f.queue(i, r), function (t, e) {
                                            g.isFunction(e) && e(null, !0)
                                        }), f.queue(i, r, [])), o(i) && "" === r && f.each(o(i).tweensContainer, function (t, e) {
                                            e.endValue = e.currentValue
                                        }), q.push(t))
                                    })
                                })
                            }), f.each(q, function (t, e) {
                                d(e, !0)
                            }), P.promise && P.resolver(v), t();
                        default:
                            if (!f.isPlainObject(y) || g.isEmptyObject(y)) {
                                if (g.isString(y) && b.Redirects[y]) {
                                    var I = f.extend({}, w),
                                        _ = I.duration,
                                        M = I.delay || 0;
                                    return I.backwards === !0 && (v = f.extend(!0, [], v).reverse()), f.each(v, function (t, e) {
                                        parseFloat(I.stagger) ? I.delay = M + parseFloat(I.stagger) * t : g.isFunction(I.stagger) && (I.delay = M + I.stagger.call(e, t, S)), I.drag && (I.duration = parseFloat(_) || (/^(callout|transition)/.test(y) ? 1e3 : m), I.duration = Math.max(I.duration * (I.backwards ? 1 - t / S : (t + 1) / S), .75 * I.duration, 200)), b.Redirects[y].call(e, e, I || {}, t, S, v, P.promise ? P : n)
                                    }), t()
                                }
                    ...
                    var $, I = f.extend({}, b.defaults, w);
                    if (I.loop = parseInt(I.loop), $ = 2 * I.loop - 1, I.loop)
                        for (var Q = 0; $ > Q; Q++) {
                            var F = {
                                delay: I.delay,
                                progress: I.progress
                            };
                            Q === $ - 1 && (F.display = I.display, F.visibility = I.visibility, F.complete = I.complete), k(v, "reverse", F)
                        }
                    return t()
                }
            };
            ...
            }), t.Velocity = b, t !== e && (t.fn.velocity = k, t.fn.velocity.defaults = b.defaults), f.each(["Down", "Up"], function (t, e) {
        ...
        function T(t) {
            ...
            return new(e = i ? i : mt ? F : yt ? R : vt ? W : Q)(t, O)
        }
        ...
        function A(t, e) {
            ...
            var r = i.firstInput,
                ...
                l = e.center = I(n);
            e.timeStamp = pt(), e.deltaTime = e.timeStamp - r.timeStamp, e.angle = j(s, l), e.distance = V(s, l), P(i, e), e.offsetDirection = M(e.deltaX, e.deltaY), e.scale = o ? $(o.pointers, n) : 1, e.rotation = o ? D(o.pointers, n) : 0, E(i, e);
            var u = t.element;
        ...
        function P(t, e) {
            var i = e.center,
                ...
                a = t.prevDelta || {},
                r = t.prevInput || {};
            (e.eventType === St || r.eventType === Ot) && (a = t.prevDelta = {
                x: r.deltaX || 0,
                y: r.deltaY || 0
            }, n = t.offsetDelta = {
                x: i.x,
        ...
        function E(t, e) {
            ...
            if (e.eventType != At && (l > Ct || s.velocity === n)) {
                var u = s.deltaX - e.deltaX,
                    c = s.deltaY - e.deltaY,
                    d = _(l, u, c);
                a = d.x, r = d.y, i = ft(d.x) > ft(d.y) ? d.x : d.y, o = M(u, c), t.lastInterval = e
        ...
        function M(t, e) {
            return t === e ? Pt : ft(t) >= ft(e) ? t > 0 ? Et : qt : e > 0 ? It : _t
        }
        ...
        function Q() {
            this.evEl = Ft, this.evWin = Lt, this.allow = !0, this.pressed = !1, S.apply(this, arguments)
        }

        function F() {
            this.evEl = zt, this.evWin = Wt, S.apply(this, arguments), this.store = this.manager.session.pointerEvents = []
        }
        ...
        function N(t, e) {
            ...
            return e & (Ot | At) && (i = w(i.concat(n), "identifier", !0)), [i, n]
        }
        ...
        function z(t, e) {
            var i = b(t.touches),
                n = this.targetIds;
            if (e & (St | Tt) && 1 === i.length) return n[i[0].identifier] = !0, [i, i];
            ...
            for (a = 0; a < o.length;) n[o[a].identifier] && s.push(o[a]), e & (Ot | At) && delete n[o[a].identifier], a++;
        ...
        function Y(t) {
            this.id = k(), this.manager = null, this.options = l(t || {}, this.defaults), this.options.enable = f(this.options.enable, !0), this.state = ae, this.simultaneous = {}, this.requireFail = []
        }
        ...
        function G(t) {
            return t == _t ? "down" : t == It ? "up" : t == Et ? "left" : t == qt ? "right" : ""
        }
        ...
        function at(t, e) {
            return e = e || {}, e.recognizers = f(e.recognizers, at.defaults.preset), new rt(t, e)
        }

        function rt(t, e) {
            e = e || {}, this.options = l(e, at.defaults), this.options.inputTarget = this.options.inputTarget || t, this.handlers = {}, this.session = {}, this.recognizers = [], this.element = t, this.input = T(this), this.touchAction = new H(this, this.options.touchAction), ot(this, !0), o(e.recognizers, function (t) {
        ...
        var lt = ["", "webkit", "moz", "MS", "ms", "o"],
            ...
            yt = vt && gt.test(navigator.userAgent),
            bt = "touch",
            wt = "pen",
            xt = "mouse",
            kt = "kinect",
        ...
        u(Q, S, {
            handler: function (t) {
                var e = Qt[t.type];
                e & St && 0 === t.button && (this.pressed = !0), e & Tt && 1 !== t.which && (e = Ot), this.pressed && this.allow && (e & Ot && (this.pressed = !1), this.callback(this.manager, e, {
                    pointers: [t],
                    changedPointers: [t],
                    pointerType: xt,
                    srcEvent: t
        ...
        t.MSPointerEvent && (zt = "MSPointerDown", Wt = "MSPointerMove MSPointerUp MSPointerCancel"), u(F, S, {
            handler: function (t) {
                var e = this.store,
                    i = !1,
                ...
                a & St && (0 === t.button || o) ? 0 > s && (e.push(t), s = e.length - 1) : a & (Ot | At) && (i = !0), 0 > s || (e[s] = t, this.callback(this.manager, a, {
                    pointers: e,
                    changedPointers: [t],
                    pointerType: r,
                    srcEvent: t
        ...
        u(L, S, {
            handler: function (t) {
                ...
                if (e === St && (this.started = !0), this.started) {
                    ...
                    e & (Ot | At) && 0 === i[0].length - i[1].length && (this.started = !1), this.callback(this.manager, e, {
                        pointers: i[0],
                        changedPointers: i[1],
                        pointerType: bt,
                        srcEvent: t
        ...
        u(R, S, {
            ...
            handler: function (t, e, i) {
                ...
                e & (Ot | At) && (this.mouse.allow = !0), this.callback(t, e, i)
            },
            destroy: function () {
            ...
            preventDefaults: function (t) {
                if (!Zt) {
                    ...
                    var n = this.actions,
                        ...
                        r = v(n, ne),
                        o = v(n, ie);
                    return a || r && i & Mt || o && i & Vt ? this.preventSrc(e) : void 0
                }
            },
        ...
        Y.prototype = {
            ...
            process: function (t) {
                var e = this.state,
                    ...
                    n = e & (re | oe),
                    a = this.attrTest(t);
                return n && (i & At || !a) ? e | ue : n || a ? i & Ot ? e | se : e & re ? e | oe : re : ce
            }
        }), u(J, Z, {
            defaults: {
                event: "pan",
            ...
            getTouchAction: function () {
                var t = this.options.direction,
                    e = [];
                return t & Mt && e.push(ne), t & Vt && e.push(ie), e
            },
            directionTest: function (t) {
                var e = this.options,
                    ...
                    r = t.deltaX,
                    o = t.deltaY;
                return a & e.direction || (e.direction & Mt ? (a = 0 === r ? Pt : 0 > r ? Et : qt, i = r != this.pX, n = Math.abs(t.deltaX)) : (a = 0 === o ? Pt : 0 > o ? It : _t, i = o != this.pY, n = Math.abs(t.deltaY))), t.direction = a, i && n > e.threshold && a & e.direction
            },
            attrTest: function (t) {
            ...
            process: function (t) {
                ...
                if (this._input = t, !n || !i || t.eventType & (Ot | At) && !r) this.reset();
            ...
            emit: function (t) {
                this.state === le && (t && t.eventType & Ot ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = pt(), this.manager.emit(this.options.event, this._input)))
            }
        }), u(et, Z, {
            defaults: {
                event: "rotate",
            ...
            attrTest: function (t) {
                ...
                return i & (Mt | Vt) ? e = t.velocity : i & Mt ? e = t.velocityX : i & Vt && (e = t.velocityY), this._super.attrTest.call(this, t) && i & t.direction && t.distance > this.options.threshold && ft(e) > this.options.velocity && t.eventType & Ot
            },
            emit: function (t) {
                var e = G(t.direction);
        ...
        rt.prototype = {
            ...
            recognize: function (t) {
                ...
                if (!e.stopped) {
                    ...
                    for (var r = 0; r < n.length;) i = n[r], e.stopped === fe || a && i != a && !i.canRecognizeWith(a) ? i.reset() : i.recognize(t), !a && i.state & (re | oe | se) && (a = e.curRecognizer = i), r++
                }
            },
            get: function (t) {
    ...
    function (t) {
        t.fn.collapsible = function (e) {
            ...
            return e = t.extend(i, e), this.each(function () {
                function i(t) {
                    r = a.find(".collapsible-header"), t.parent().toggleClass("active"), t.parent().hasClass("active") ? t.siblings(".collapsible-body").stop(!0, !1).slideDown({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1
                        ...
                        easing: "easeOutQuart",
                        queue: !1
                    }), r.not(t).parent().removeClass("active"), r.not(t).parent().children(".collapsible-body").stop(!0, !1).slideUp({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1
                    })
                ...
                function n(t) {
                    t.parent().toggleClass("active"), t.parent().hasClass("active") ? t.siblings(".collapsible-body").stop(!0, !1).slideDown({
                        duration: 350,
                        easing: "easeOutQuart",
                        queue: !1
                    }) : t.siblings(".collapsible-body").stop(!0, !1).slideUp({
                ...
                var a = t(this),
                    r = t(this).find(".collapsible-header"),
                    o = a.data("collapsible");
                a.off("click.collapse", ".collapsible-header"), r.off("click.collapse"), e.accordion || "accordion" == o || void 0 == o ? (a.on("click.collapse", ".collapsible-header", function (e) {
                    i(t(e.currentTarget))
    ...
    function (t) {
        t.fn.scrollTo = function (e) {
            ...
            e = t.extend(i, e), this.each(function () {
                function i() {
                    void 0 != o.data("inDuration") && (e.inDuration = o.data("inDuration")), void 0 != o.data("outDuration") && (e.outDuration = o.data("outDuration")), void 0 != o.data("constrainwidth") && (e.constrain_width = o.data("constrainwidth")), void 0 != o.data("hover") && (e.hover = o.data("hover")), void 0 != o.data("alignment") && (e.alignment = o.data("alignment")), void 0 != o.data("gutter") && (e.gutter = o.data("gutter")), void 0 != o.data("beloworigin") && (e.belowOrigin = o.data("beloworigin"))
                }

                function n() {
                    i(), 1 == e.constrain_width && s.css("width", o.outerWidth());
                    var n = 0;
                    1 == e.belowOrigin && (n = o.height());
                    var r = 0,
                        u = e.gutter;
                    "right" == e.alignment && (r = o.innerWidth() - s.innerWidth(), u = -1 * u), s.css(a(o[0]) ? {
                        display: "block",
                        position: "fixed",
                        height: 0,
                        top: o.offset().top - t(window).scrollTop() + n,
                        left: o.offset().left + r + u
                    } : {
                        display: "block",
                        top: o.offset().top + n,
                        left: o.offset().left + r + u,
                ...
                function a(e) {
                    ...
                    return n.each(function () {
                        return "fixed" === t(this).css("position") ? (a = !0, !1) : void 0
                    }), a
                }
                ...
                var o = t(this),
                    s = t("#" + o.attr("data-activates"));
                i(), s.parent().is(t("body")) || (s.detach(), t("body").append(s));
                var l = s.height();
                e.hover ? (o.on("mouseover", function () {
                    n()
                }), s.on("mouseleave", function () {
                    r()
                })) : (o.unbind("click." + o.attr("id")), o.bind("click." + o.attr("id"), function (e) {
                    o[0] == e.currentTarget && (e.preventDefault(), n()), t(document).bind("click." + s.attr("id"), function (e) {
                        !s.is(e.target) && !o.is(e.target) && !o.find(e.target).length > 0 && (r(), t(document).unbind("click." + s.attr("id")))
                    })
                })), o.on("open", n), o.on("close", r)
            })
        }
    }(jQuery),
    function (t) {
        t.fn.extend({
            ...
            closeModal: function (e) {
                var i = {
                    ...
                    e = t.extend(i, e);
                t(".modal-close").off(), t("#lean-overlay").velocity({
                    opacity: 0
                }, {
            ...
            return this.each(function () {
                function e() {
                    ...
                    var e = o.parent(".material-placeholder"),
                        ...
                        s = o.data("height");
                    t("#materialbox-overlay").fadeOut(r, function () {
                        i = !1, t(this).remove()
                    }), o.velocity({
                        width: a,
                        height: s,
                ...
                if (!t(this).hasClass("intialized")) {
                    ...
                    o.wrap(s), o.on("click", function () {
                        ...
                        if (t("body").append(d), d.velocity({
                            ...
                            var f = t('<div class="materialbox-caption"></div>');
                            f.text(o.data("caption")), t("body").append(f), f.css({
                                display: "inline"
                            }), f.velocity({
                                opacity: 1
                            }, {
                        ...
                        var p = 0,
                            ...
                            m = 0;
                        h > g ? (p = c / u,
                            v = .9 * s, m = .9 * s * p) : (p = u / c, v = .9 * l * p, m = .9 * l), o.hasClass("responsive-img") ? o.velocity({
                            "max-width": v,
                            width: u
                        }, {
                            duration: 0,
                            ...
                            complete: function () {
                                o.css({
                                    ...
                                    height: m,
                                    width: v,
                                    left: t(document).scrollLeft() + s / 2 - o.parent(".material-placeholder").offset().left - v / 2,
    ...
    function (t) {
        t.fn.parallax = function () {
            ...
            return this.each(function () {
                function i(i) {
                    var a;
                    a = 992 > e ? n.height() > 0 ? n.height() : n.children("img").height() : n.height() > 0 ? n.height() : 500;
                    var r = n.children("img").height(),
                        o = r - a,
                        s = n.offset().top + a,
                        l = n.offset().top,
                        ...
                        f = (d - l) / (a + c),
                        p = -1 * o * f;
                    s > u && u + c > l && n.children("img").first().css("bottom", p + "px"), i && n.children("img").first().css("display", "block")
                }
                var n = t(this);
                n.addClass("parallax"), n.find("img").each(function () {
                ...
                }), n.children("img").one("load", function () {
                    i(!0)
                }).each(function () {
        ...
        var e = {
            init: function (e) {
                ...
                e = t.extend(i, e), t(this).each(function () {
                    ...
                    240 != e.menuWidth && (a.css("width", e.menuWidth), a.hasClass("fixed") || a.css("left", -1 * (e.menuWidth + 10))), "left" != e.edge && a.addClass("right-aligned"), t("body").append(t('<div class="drag-target"></div>')), t(".drag-target").css("left" === e.edge ? {
                        left: 0
                    } : {
                        right: 0
                    }), a.hasClass("fixed") && t(window).resize(function () {
                        t(window).width() > 1200 && a.attr("style") && (a.removeAttr("style"), a.css("width", e.menuWidth)), 0 != t("#sidenav-overlay").css("opacity") && o && t("#sidenav-overlay").trigger("click")
                    ...
                    t(".drag-target").hammer({
                        ...
                        if ("touch" === n.gesture.pointerType) {
                            ...
                            if (n.gesture.center.y, n.gesture.velocityX, !t("#sidenav-overlay").length) {
                                var s = t('<div id="sidenav-overlay"></div>');
                                s.css("opacity", 0).click(function () {
                                    i()
                                }), t("body").append(s)
                            }
                            if ("left" === e.edge ? r > e.menuWidth ? r = e.menuWidth : 0 > r && (r = 0) : r < t(window).width() - e.menuWidth && (r = t(window).width() - e.menuWidth), "left" === e.edge ? (r < e.menuWidth / 2 ? o = !1 : r >= e.menuWidth / 2 && (o = !0), a.css("left", r - e.menuWidth)) : (r < t(window).width() - e.menuWidth / 2 ? o = !0 : r >= t(window).width() - e.menuWidth / 2 && (o = !1), a.css("right", -1 * (r - e.menuWidth / 2))), "left" === e.edge) {
                                var l = r / e.menuWidth;
                                ...
                                var l = Math.abs((r - t(window).width()) / e.menuWidth);
                                t("#sidenav-overlay").velocity({
                                    opacity: l
                                }, {
                                    duration: 50,
    ...
    function (t) {
        t(document).ready(function () {
            ...
            if (t(document).on("change", e, function () {
                    0 !== t(this).val().length && t(this).siblings("label, i").addClass("active"), validate_field(t(this))
                }), t(document).ready(function () {
                    t(e).each(function (e, i) {
                        t(i).val().length > 0 && t(this).siblings("label, i").addClass("active")
                    })
                }), t(document).on("reset", function (i) {
                    t(i.target).is("form") && (t(this).find(e).removeClass("valid").removeClass("invalid"), t(this).find("select.initialized").each(function () {
                    ...
                    0 === t(this).val().length && t(this).siblings("label, i").removeClass("active"), validate_field(t(this))
                ...
                var i = t('<div class="hiddendiv common"></div>'),
                    n = null;
                t("body").append(i)
            }
            var a = ".materialize-textarea";
            t(".hiddendiv").css("width", t(a).width()), t(a).each(function () {
                t(this).val().length && (n = t(this).val(), n = n.replace(/\n/g, "<br>"), i.html(n + "<br>"), t(this).css("height", i.height()))
            }), t("body").on("keyup keydown", a, function () {
                n = t(this).val(), n = n.replace(/\n/g, "<br>"), i.html(n + "<br>"), t(this).css("height", i.height())
                ...
                t(this).each(function () {
                    if ($select = t(this), !$select.hasClass("browser-default") && !$select.hasClass("initialized")) {
                        var i = l(),
                            ...
                            a = t('<ul id="select-options-' + i + '" class="dropdown-content select-dropdown"></ul>'),
                            r = $select.children("option");
                        if (void 0 !== $select.find("option:selected")) var o = $select.find("option:selected");
                        else var o = a.first();
                        r.each(function () {
                        ...
                        var s = t('<input type="text" class="select-dropdown" readonly="true" ' + ($select.is(":disabled") ? "disabled" : "") + ' data-activates="select-options-' + i + '" value="' + o.html() + '"/><i class="mdi-navigation-arrow-drop-down">');
                        $select.before(s), t("body").append(a), $select.is(":disabled") || s.dropdown({
                            hover: !1
                        }), $select.addClass("initialized"), s.on("focus", function () {
                            t(this).trigger("open"), o = t(this).val(), selectedOption = a.find("li").filter(function () {
                                return t(this).text().toLowerCase() === o.toLowerCase()
                            ...
                            return 9 == e.which ? void s.trigger("close") : 40 != e.which || a.is(":visible") ? void((13 != e.which || a.is(":visible")) && (e.preventDefault(), letter = String.fromCharCode(e.which).toLowerCase(), letter && (filterQuery.push(letter), string = filterQuery.join(""), newOption = a.find("li").filter(function () {
                ...
                r.hammer({
                    ...
                    if ("touch" === t.gesture.pointerType) {
                        ...
                        $curr_slide = o.find(".active"), $curr_slide.velocity({
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), 4 === e && (i > r.innerWidth() / 2 || -.65 > n) ? f = !0 : 2 === e && (i < -1 * r.innerWidth() / 2 || n > .65) && (d = !0);
                        var a;
                        d && (a = $curr_slide.next(), 0 === a.length && (a = s.first()), a.velocity({
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        })), f && (a = $curr_slide.prev(), 0 === a.length && (a = s.last()), a.velocity({
                            opacity: 1
                        }, {
                            duration: 300,
                            queue: !1,
                    ...
                    "touch" === t.gesture.pointerType && ($curr_slide = o.find(".active"), c = !1, curr_index = o.find(".active").index(), f || d ? d ? (n(curr_index + 1), $curr_slide.velocity({
        ...
        t(document).ready(function () {
            t(document).on("click.card", ".card", function (e) {
                t(this).find(".card-reveal").length && (t(e.target).is(t(".card-reveal .card-title")) || t(e.target).is(t(".card-reveal .card-title i")) ? t(this).find(".card-reveal").velocity({
                    ...
                    queue: !1,
                    easing: "easeInOutQuad"
                }) : (t(e.target).is(t(".card .activator")) || t(e.target).is(t(".card .activator i"))) && t(this).find(".card-reveal").velocity({
                    translateY: "-100%"
                }, {
                    duration: 300,
                    queue: !1,
    ...
    function (t) {
        t(document).ready(function () {
            ...
            t.fn.pushpin = function (i) {
                var n = {
                    top: 0,
                    bottom: 1 / 0,
                    offset: 0
                };
                return i = t.extend(n, i), $index = 0, this.each(function () {
                    function n(t) {
                    ...
                    function a(e, a) {
                        e.each(function () {
                            i.top <= a && i.bottom >= a && !t(this).hasClass("pinned") && (n(t(this)), t(this).css("top", i.offset), t(this).addClass("pinned")), a < i.top && !t(this).hasClass("pin-top") && (n(t(this)), t(this).css("top", 0), t(this).addClass("pin-top")), a > i.bottom && !t(this).hasClass("pin-bottom") && (n(t(this)), t(this).addClass("pin-bottom"), t(this).css("top", i.bottom - s))
                        })
                    }
                    var r = e(),
                        o = t(this),
                        s = t(this).offset().top;
                    a(o, t(window).scrollTop()), t(window).on("scroll." + r, function () {
                        var e = t(window).scrollTop() + i.offset;
                        a(o, e)
                    })
                })
            }
    ...
    function (t) {
        t(document).ready(function () {
            t.fn.reverse = [].reverse, t(document).on("mouseenter.fixedActionBtn", ".fixed-action-btn", function () {
                ...
                var i = 0;
                e.find("ul a.btn-floating").reverse().each(function () {
                    t(this).velocity({
                        opacity: "1",
                        scaleX: "1",
                        scaleY: "1",
                ...
                var e = t(this);
                e.find("ul a.btn-floating").velocity("stop", !0), e.find("ul a.btn-floating").velocity({
                    opacity: "0",
                    scaleX: ".4",
                    scaleY: ".4",
                    translateY: "40px"
    ...
    function (t) {
        t(document).ready(function () {
            ...
            var e = [];
            t("ul.staggered-list").each(function (i) {
                var n = "scrollFire-" + i;
                t(this).addClass(n), e.push({
                    selector: "ul.staggered-list." + n,
                    offset: 200,
                    callback: 'showStaggeredList("ul.staggered-list.' + n + '")'
                })
            }), scrollFire(e);
            var i = !1,
                n = !1;
                ...
                t(this).hammer({
                    ...
                    if ("touch" === e.gesture.pointerType) {
                        ...
                        a.velocity({
                            ...
                            queue: !1,
                            easing: "easeOutQuad"
                        }), 4 === r && (o > a.innerWidth() / 2 || -.75 > s) ? i = !0 : 2 === r && (o < -1 * a.innerWidth() / 2 || s > .75) && (n = !0)
                    }
                    ...
                    if ("touch" === e.gesture.pointerType) {
                        ...
                        if (i || n) {
                            var r;
                            r = i ? a.innerWidth() : -1 * a.innerWidth(), a.velocity({
                                translateX: r
                            }, {
                                duration: 100,
                                queue: !1,
    ...
    function (t) {
        scrollFire = function (e) {
            t(window).scroll(function () {
                var i = t(window).scrollTop() + t(window).height();
    ...
    function (t) {
        ...
        function e(r, o, l, d) {
            ...
            function p() {
                k.data(o, S).addClass(x.input).attr("tabindex", -1).val(k.data("value") ? S.get("select", w.format) : r.value), w.editable || k.on("focus." + b.id + " click." + b.id, function (t) {
                    t.preventDefault(), S.$root[0].focus()
                }).on("keydown." + b.id, v), a(r, {
                    haspopup: !0,
                    expanded: !1,
                    readonly: !1,
                    owns: r.id + "_root"
            ...
            function g() {
                var e;
                w.hiddenName === !0 ? (e = r.name, r.name = "") : (e = ["string" == typeof w.hiddenPrefix ? w.hiddenPrefix : "", "string" == typeof w.hiddenSuffix ? w.hiddenSuffix : "_submit"],
                    e = e[0] + r.name + e[1]), S._hidden = t('<input type=hidden name="' + e + '"' + (k.data("value") || r.value ? ' value="' + S.get("select", w.formatSubmit) + '"' : "") + ">")[0], k.on("change." + b.id, function () {
                    S._hidden.value = r.value ? S.get("select", w.formatSubmit) : ""
                }), w.container ? t(w.container).append(S._hidden) : k.after(S._hidden)
            }
            ...
            var y = !1,
                ...
                S = C.prototype = {
                    ...
                    $node: k,
                    start: function () {
                        return b && b.start ? S : (b.methods = {}, b.start = !0, b.open = !1, b.type = r.type, r.autofocus = r == s(), r.readOnly = !w.editable, r.id = r.id || b.id, "text" != r.type && (r.type = "text"), S.component = new l(S, w), S.$root = t(e._.node("div", f(), x.picker, 'id="' + r.id + '_root" tabindex="0"')), h(), w.formatSubmit && g(), p(), w.container ? t(w.container).append(S.$root) : k.after(S.$root), S.on({
                    ...
                    render: function (t) {
                        return t ? S.$root.html(f()) : S.$root.find("." + x.box).html(S.component.nodes(b.open)), S.trigger("render")
                    },
                    stop: function () {
                        return b.start ? (S.close(), S._hidden && S._hidden.parentNode.removeChild(S._hidden), S.$root.remove(), k.removeClass(x.input).removeData(o), setTimeout(function () {
                            k.off("." + b.id)
                        }, 0), r.type = b.type, r.readOnly = !1, S.trigger("stop"), b.methods = {}, b.start = !1, S) : S
                    },
                    open: function (i) {
                        return b.open ? S : (k.addClass(x.active), a(r, "expanded", !0), setTimeout(function () {
                    ...
                    close: function (t) {
                        ...
                        }, 0)), k.removeClass(x.active), a(r, "expanded", !1), setTimeout(function () {
                    ...
                    set: function (e, i, n) {
                        ...
                        if (n = o && t.isPlainObject(i) ? i : n || {}, e) {
                            o || (s[e] = i);
                            for (a in s) r = s[a], a in S.component.item && (void 0 === r && (r = null), S.component.set(a, r, n)), ("select" == a || "clear" == a) && k.val("clear" == a ? "" : S.get(a, w.format)).trigger("change");
                            S.render()
                        }
    ...
    function (t) {
        ...
        i.prototype.set = function (t, e, i) {
            ...
            if ((!n || !n.nav) && (!f && u.disabled(i) || f && u.disabled(i) && (g || a || o) || !f && (i.pick <= p.pick || i.pick >= h.pick)))
                for (f && !g && (!o && d > 0 || !a && 0 > d) && (d *= -1); u.disabled(i) && (Math.abs(d) > 1 && (i.month < c.month || i.month > c.month) && (i = c, d = d > 0 ? 1 : -1), i.pick <= p.pick ? (s = !0, d = 1, i = u.create([p.year, p.month, p.date + (i.pick === p.pick ? 0 : -1)])) : i.pick >= h.pick && (l = !0, d = -1, i = u.create([h.year, h.month, h.date + (i.pick === h.pick ? 0 : 1)])), !s || !l);) i = u.create([i.year, i.month, i.date + d]);
            return i
            ...
            var e = this,
                ...
                g = function (t) {
                    return r.node("div", " ", i.klass["nav" + (t ? "Next" : "Prev")] + (t && c.year >= p.year && c.month >= p.month || !t && c.year <= f.year && c.month <= f.month ? " " + i.klass.navDisabled : ""), "data-nav=" + (t || -1) + " " + r.ariaAttr({
                        role: "button",
                ...
                v = function (n) {
                    ...
                    return "short_months" == n && (a = i.monthsShort), i.selectMonths && void 0 == n ? r.node("select", r.group({
                        ...
                        node: "option",
                        item: function (t) {
                            return [a[t], 0, "value=" + t + (c.month == t ? " selected" : "") + (c.year == f.year && t < f.month || c.year == p.year && t > p.month ? " disabled" : "")]
                        }
            ...
            return createDayLabel = function () {
                ...
                return e
            }, r.node("div", r.node("div", createWeekdayLabel(), "picker__weekday-display") + r.node("div", v("short_months"), i.klass.month_display) + r.node("div", createDayLabel(), i.klass.day_display) + r.node("div", m("raw"), i.klass.year_display), i.klass.date_display) + r.node("div", r.node("div", (i.selectYears ? v() + m() : v() + m()) + g() + g(1), i.klass.header) + r.node("table", h + r.node("tbody", r.group({
                min: 0,
                max: a - 1,
                i: 1,
                node: "tr",
                    ...
                    return [r.group({
                        ...
                        item: function (t) {
                            ...
                            var n = l && l.pick == t.pick,
                                a = u && u.pick == t.pick,
                                o = d && e.disabled(t) || t.pick < f.pick || t.pick > p.pick,
