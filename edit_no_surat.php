...
if (empty($_SESSION['admin'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        $id = $_REQUEST['id'];
        $query = mysqli_query($config, "SELECT * FROM tbl_no_surat WHERE id='$id'");
        list($id) = mysqli_fetch_array($query);
                    ...
                    if (!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $klasifikasi1)) {
                        ...
                        if (!preg_match("/^[0-9.-]*$/", $tgl_surat)) {
                            ...
                            if (!preg_match("/^[a-zA-Z0-9.,()\/ -]*$/", $jenis_surat)) {
                                ...
                                $query = mysqli_query($config, "UPDATE tbl_nomor_surat SET no_surat='$no_surat', klasifikasi='$klasifikasi', klasifikasi1='$klasifikasi1', tgl_surat='$tgl_surat', id_user='$id_user', jenis_surat='$jenis_surat' WHERE id='$id'");
                                if ($query == true) {
                                    $_SESSION['succEdit'] = 'SUKSES! Data berhasil diupdate';
                                    echo '<script language="javascript">
                                                window.location.href="./admin.php?page=ns&act=disp&id=' . $id . '";
                                              </script>';
                                } else {
        ...
        $query = mysqli_query($config, "SELECT * FROM tbl_surat_masuk WHERE id='$id'");
                    ...
                    <div class="col s12">
                        <nav class="secondary-nav">
                            <div class="nav-wrapper blue-grey darken-1">
                                <ul class="left">
                                    <li class="waves-effect waves-light"><a href="#" class="judul"><i class="material-icons">edit</i> Edit Nomor Surat</a></li>
                                </ul>
                            </div>
                        </nav>
                    </div>
            ...
            <form class="col s12" method="POST" action="">
                ...
                <div class="row">
                    ...
                    <div class="input-field col s6">
                        ...
                        <input id="no_surat" type="text" class="validate" name="no_surat" value="<?php echo $row['no_surat'] ;?>" required>
                        <?php
                    ...
                    <div class="input-field col s6">
                        ...
                        <input id="tgl_surat" type="text" name="tgl_surat" class="datepicker" value="<?php echo $row['tgl_surat'] ;?>" required>
                        <?php
                    ...
                    <div class="input-field col s12">
                            <select name="klasifikasi" id="klasifikasi" required>
                                <option value="<?php echo $row['klasifikasi']; ?>"><?php echo $row['klasifikasi']; ?></option>
                    ...
                    <i class="material-icons prefix md-prefix">filter_2</i><label>Klasifikasi 1</label><br />
                        <div class="input-field col s12">
                            <select name="klasifikasi1" id="klasifikasi1" required>
                                <option value="<?php echo $row['klasifikasi1']; ?>"><?php echo $row['klasifikasi1']; ?></option>
                                <option value="Option 1">Option 1</option>
                                <option value="Option 2">Option 2</option>
                                <option value="Option 3">Option 3</option>
                            </select>
                    ...
                    <div class="input-field col s6">
                        ...
                        ?>
                            ...
                            <div class="row">
                                ...
                                <div class="col 6">
                                    <a href="?page=ns&act=disp&id_surat=<?php echo $row['id']; ?>" class="btn-large deep-orange waves-effect waves-light">BATAL <i class="material-icons">clear</i></a>
                                </div>
                            </div>
